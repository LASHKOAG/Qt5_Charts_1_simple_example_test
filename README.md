...
```
git clone https://gitflic.ru/project/lashko_ag/qt5_charts_1_simple_example.git
cd qt5_charts_1_simple_example
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/lashko_ag/qt5_charts_1_simple_example.git
git clone
